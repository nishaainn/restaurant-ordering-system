...
$count = 1;
$sql1= "SELECT menuorder.ID,menuorder.order_ID, name ,payment.amount,menuorder.date FROM menuorder INNER JOIN payment ON menuorder.order_ID = payment.order_ID WHERE payment.status = 'pending' ";  
...
<meta charset="UTF-8">
    ...
    <title>Qrispy Pizza - Active Order</title>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">List Active Orders</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
